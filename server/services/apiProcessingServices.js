    ...
    //## within each step
        ...
        //##--check level, 1-5
            ...
            if( currentStepObject.dataLevel==1){//## process level 1 data, becuase current processing step is also for level 1
                ...
                if ( preConditionResponseObject.success){
                    ...
                    if (processResult.success){
                       ...
                       //no return, process dont stop, continue to next loop.
                        ...
                        return responseObject(false,"API_PROCESSING_ERROR","Step: "+currentStepObject.stepNumber+". "+processResult.message,data);
                        break loopStep;
                    }
                ...
                console.log("apiProcessing in apiProcessingServices.js: level 2 data processing starts.","Step: ",currentStepObject.stepNumber);
